...
Специализированный фреймворк для создания Telegram ботов с многошаговыми диалогами, где структура сообщений и флоу описывается в YAML файлах, а бизнес-логика остается в коде.
